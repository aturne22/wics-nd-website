      ...
      <div className="events-carousel">
        <Slider {...settings}>
          <div className="slide">
            ...
            <img src={girlsWhoCodeImg} alt="Girls Who Code" className="slide-image"/>
            <p>Through Girls Who Code, ND student volunteers teach CS courses 
              to girls in local high schools to help decrease the gap of 
              women in STEM. GWC provides lesson plans and curriculum content.  
              Python games and HTML/CSS/JS websites!</p>
          </div>
          <div className="slide">
       
            <h2>Workshops & Panels</h2>
            <img src={panelsImg} alt="Workshops & Panels" className="slide-image"/>
            <p>WiCS proudly hosts resume workshops and internship panels designed 
              ...
              their insights and tips for landing internships.</p>
          </div>
          <div className="slide">
            <h2>WiCS Conferences</h2>
            <img src={conferenceImg} alt="Conference" className="slide-image"/>
            <p>WiCS actively participates in the Grace Hopper Celebration every year, the 
              ...
              leading to internships and job offers.</p>
          </div>
        </Slider>
      </div>
